<nav class="bg-gray-800" x-data="{isOpen : false}">
    ...
    class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        ...
        <x-my-nav-link class="block" href="/contact" :current="request()->is('contact')">Contact</x-my-nav-link>        </div>
      ...
      <div class="border-t border-gray-700 pt-4 pb-3">
        ...
        <div class="mt-3 space-y-1 px-2">
          ...
          <a href="/dasboard" class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">Settings</a>
          <form method="post" action="/logout">
            @csrf
            <button type="submit" class="block text-start rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white cursor-pointer" role="menuitem" tabindex="-1" id="user-menu-item-2">Log out</button>
          </form>        
        </div>
        @else
        <div class="my-3 space-y-1 px-2">
          <a href="/login" class="text-white text-sm font-medium block">Login</a>
          <a href="/register" class="text-white text-sm font-medium block">Register</a>
        </div>
        @endif
