...
<div class="max-w-4xl relative p-4 bg-white rounded-lg border dark:bg-gray-800 sm:p-5">
    ...
    <!-- Modal body -->
    <form action="/dashboard" method="POST" id="postForm" enctype="multipart/form-data">
        @csrf
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <textarea id="body" name="body" rows="4"
                class="hidden @error('body') bg-red-50 border-red-500 text-red-700 placeholder-red-700 focus:ring-red-500 focus:border-red-500 @enderror block p-2.5 w-full text-sm text-gray-900 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
        ...
        const quill = new Quill('#editor', {
            ...
            modules: {
                toolbar: [
                    ...
                    ['link', 'image'], // Tambahkan 'image' di sini
