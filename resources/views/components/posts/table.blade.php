...
<section class="p-3 sm:p-5 antialiased">
    <h2 class="text-2xl font-semibold pl-4 mb-4">Post by: {{ Auth::user()->name }}</h2>
        ...
        <div class="bg-white dark:bg-gray-800 relative border sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row items-center space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div
                    ...
                    <a href="/dashboard/create" id="createProductModalButton12" data-modal-target="createProductModal21"
                        data-modal-toggle="createProductModal12"
