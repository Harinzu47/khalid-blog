    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            <label class="block mb-2 text-sm font-medium text-gray-800 dark:text-white" for="avatar">Upload
                Avatar</label>
            <input
                class=" @error('avatar') bg-red-50  border-red-500 text-red-700 placeholder-red-700 focus:ring-red-500 focus:border-red-500 @enderror block w-full text-sm text-gray-800 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
        ...
        <div>
            <img class="rounded-full w-36 h-36"
                ...
                alt="Extra large avatar" id="avatar-preview">
        </div>
